...
class WikiDataset(DatasetAbstract):
    ...
    def initialize_data_set_parameters(self):
        ...
        self.corpus_attribute_name = {  WikiDataset.SOURCE+WikiDataset.SENTENCE_TOKEN_NAME:"src_text",   
                                        WikiDataset.TARGET+WikiDataset.SENTENCE_TOKEN_NAME:"trg_text",  
                                        WikiDataset.SCORE_TOKEN_NAME:"aligment"
        }   
        self.data_set_type_name = {WikiDataset.DATA_SET_TYPE_TRAIN:None, 
                                   WikiDataset.DATA_SET_TYPE_VALIDATION:None, 
                                   WikiDataset.DATA_SET_TYPE_TEST:"test"  
        }
        

        self.path_to_data = self.params["path_wiki_test"]
                
        self.type_to_file = {self.data_set_type_name[WikiDataset.DATA_SET_TYPE_TRAIN]:"train.tsv",   
                             self.data_set_type_name[WikiDataset.DATA_SET_TYPE_TEST]:"wiki_paragraphs.tsv",  
                             self.data_set_type_name[WikiDataset.DATA_SET_TYPE_VALIDATION]:"valid.tsv"}      
