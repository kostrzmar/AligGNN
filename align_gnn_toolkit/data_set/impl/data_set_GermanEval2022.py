...
class GermanEval2022Dataset(DatasetAbstract):
    def __init__(self, root, transform=None, pre_transform=None, pre_filter=None, type="train", params=None, graph_builder=None, data_set_processor=None):
        DATA_SET_NAME = "german_eval_2022"   
    ...
    def initialize_data_set_parameters(self):
        ...
        self.corpus_attribute_name = {  GermanEval2022Dataset.SOURCE+GermanEval2022Dataset.SENTENCE_TOKEN_NAME:"Sentence DE",   
                                        GermanEval2022Dataset.TARGET+GermanEval2022Dataset.SENTENCE_TOKEN_NAME:"Sentence DE",  
                                        GermanEval2022Dataset.SCORE_TOKEN_NAME:"MOS"
        }   
        self.data_set_type_name = {GermanEval2022Dataset.DATA_SET_TYPE_TRAIN:"train", 
                                   GermanEval2022Dataset.DATA_SET_TYPE_VALIDATION:None, 
                                   GermanEval2022Dataset.DATA_SET_TYPE_TEST:"test"  
        }


        self.path_to_data = self.params["german_eval_2022_test"]
                
        self.type_to_file = {self.data_set_type_name[GermanEval2022Dataset.DATA_SET_TYPE_TRAIN]:"training_set.csv",   
                             self.data_set_type_name[GermanEval2022Dataset.DATA_SET_TYPE_TEST]:"training_set.csv",
                             #self.data_set_type_name[GermanEval2022Dataset.DATA_SET_TYPE_TEST]:"test_set.csv",  
                             self.data_set_type_name[GermanEval2022Dataset.DATA_SET_TYPE_VALIDATION]:"valid_set.csv"}      
