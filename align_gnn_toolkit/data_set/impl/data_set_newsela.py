...
class NewselaDataset(DatasetAbstract):
    ...
    def initialize_data_set_parameters(self):
        ...
        self.corpus_attribute_name = {  NewselaDataset.SOURCE+NewselaDataset.SENTENCE_TOKEN_NAME:"src_text",   
                                        NewselaDataset.TARGET+NewselaDataset.SENTENCE_TOKEN_NAME:"trg_text",  
                                        NewselaDataset.SCORE_TOKEN_NAME:"aligment"
        }   
        self.data_set_type_name = {NewselaDataset.DATA_SET_TYPE_TRAIN:"train", 
                                   NewselaDataset.DATA_SET_TYPE_VALIDATION:"validation", 
                                   NewselaDataset.DATA_SET_TYPE_TEST:"test"  
        }
        ...
        self.type_to_file = {self.data_set_type_name[NewselaDataset.DATA_SET_TYPE_TRAIN]:"train.tsv",   
                             self.data_set_type_name[NewselaDataset.DATA_SET_TYPE_TEST]:"test.tsv",  
                             self.data_set_type_name[NewselaDataset.DATA_SET_TYPE_VALIDATION]:"dev.tsv"}      
