...
class Sts14Dataset(DatasetAbstract):
    ...
    def initialize_data_set_parameters(self):
        ...
        self.corpus_attribute_name = {  Sts14Dataset.SOURCE+ Sts14Dataset.SENTENCE_TOKEN_NAME:"sentence1",   
                                        Sts14Dataset.TARGET+ Sts14Dataset.SENTENCE_TOKEN_NAME:"sentence2",  
                                        Sts14Dataset.SCORE_TOKEN_NAME:"score"
        }   
        self.data_set_type_name = {Sts14Dataset.DATA_SET_TYPE_TRAIN:None, 
                                   Sts14Dataset.DATA_SET_TYPE_VALIDATION:None, 
                                   Sts14Dataset.DATA_SET_TYPE_TEST:"test"  
        }
