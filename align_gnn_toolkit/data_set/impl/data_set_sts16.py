...
class Sts16Dataset(DatasetAbstract):
    ...
    def initialize_data_set_parameters(self):
        ...
        self.corpus_attribute_name = {  Sts16Dataset.SOURCE+ Sts16Dataset.SENTENCE_TOKEN_NAME:"sentence1",   
                                        Sts16Dataset.TARGET+ Sts16Dataset.SENTENCE_TOKEN_NAME:"sentence2",  
                                        Sts16Dataset.SCORE_TOKEN_NAME:"score"
        }   
        self.data_set_type_name = {Sts16Dataset.DATA_SET_TYPE_TRAIN:None, 
                                   Sts16Dataset.DATA_SET_TYPE_VALIDATION:None, 
                                   Sts16Dataset.DATA_SET_TYPE_TEST:"test"  
        }
