...
class Sts15Dataset(DatasetAbstract):
    ...
    def initialize_data_set_parameters(self):
        ...
        self.corpus_attribute_name = {  Sts15Dataset.SOURCE+ Sts15Dataset.SENTENCE_TOKEN_NAME:"sentence1",   
                                        Sts15Dataset.TARGET+ Sts15Dataset.SENTENCE_TOKEN_NAME:"sentence2",  
                                        Sts15Dataset.SCORE_TOKEN_NAME:"score"
        }   
        self.data_set_type_name = {Sts15Dataset.DATA_SET_TYPE_TRAIN:None, 
                                   Sts15Dataset.DATA_SET_TYPE_VALIDATION:None, 
                                   Sts15Dataset.DATA_SET_TYPE_TEST:"test"  
        }
