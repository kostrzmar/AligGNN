...
class NewselaBinaryDataset(DatasetAbstract):
    ...
    def initialize_data_set_parameters(self):
        ...
        self.corpus_attribute_name = {  NewselaBinaryDataset.SOURCE+NewselaBinaryDataset.SENTENCE_TOKEN_NAME:"src_text",   
                                        NewselaBinaryDataset.TARGET+NewselaBinaryDataset.SENTENCE_TOKEN_NAME:"trg_text",  
                                        NewselaBinaryDataset.SCORE_TOKEN_NAME:"aligment"
        }   
        self.data_set_type_name = {NewselaBinaryDataset.DATA_SET_TYPE_TRAIN:"train", 
                                   #NewselaBinaryDataset.DATA_SET_TYPE_VALIDATION:"validation", 
                                   NewselaBinaryDataset.DATA_SET_TYPE_VALIDATION:None, 
                                   NewselaBinaryDataset.DATA_SET_TYPE_TEST:"test"  
        }
        
        self.path_to_data = self.params["newsela"]
        

        
        self.type_to_file = {self.data_set_type_name[NewselaBinaryDataset.DATA_SET_TYPE_TRAIN]:"train.tsv",   
                             self.data_set_type_name[NewselaBinaryDataset.DATA_SET_TYPE_TEST]:"test.tsv",  
                             self.data_set_type_name[NewselaBinaryDataset.DATA_SET_TYPE_VALIDATION]:"dev.tsv"}      
