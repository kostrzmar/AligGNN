...
class Sts13Dataset(DatasetAbstract):
    ...
    def initialize_data_set_parameters(self):
        ...
        self.corpus_attribute_name = {  Sts13Dataset.SOURCE+ Sts13Dataset.SENTENCE_TOKEN_NAME:"sentence1",   
                                        Sts13Dataset.TARGET+ Sts13Dataset.SENTENCE_TOKEN_NAME:"sentence2",  
                                        Sts13Dataset.SCORE_TOKEN_NAME:"score"
        }   
        self.data_set_type_name = {Sts13Dataset.DATA_SET_TYPE_TRAIN:None, 
                                   Sts13Dataset.DATA_SET_TYPE_VALIDATION:None, 
                                   Sts13Dataset.DATA_SET_TYPE_TEST:"test"  
        }
